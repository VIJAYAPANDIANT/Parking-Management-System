        ...
        <div className="lg:col-span-6 w-full max-w-md mx-auto">
          <div className="backdrop-blur-md bg-white/5 dark:bg-black/30 border border-white/10 rounded-3xl shadow-2xl p-8 space-y-6">
            ...
            <div className="grid grid-cols-2 gap-3">
              <button className="flex items-center justify-center gap-2 py-2 px-4 rounded-xl bg-slate-800/40 hover:bg-slate-800 border border-slate-700/50 text-sm font-medium transition-colors">
